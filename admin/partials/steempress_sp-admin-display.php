...
<div class="wrap">
    ...
    <form method="post" name="cleanup_options" action="options.php">
        ...
        <input type="text" class="regular-text" id="<?php echo $this->plugin_name; ?>-tags" name="<?php echo $this->plugin_name; ?>[tags]" value="<?php echo sanitize_text_field(($options["tags"] == "" ? "steempress blog" : $options["tags"])); ?>"/>
        <br />
